...
void test_add_merch()
{
    ...
    char *Boll = strdup("Boll");
    char *Rund = strdup ("Rund");
    char *space = strdup(" ");
    char *Varm = strdup ("Varm");
    char *Skog = strdup("Skog");
    char *Trad = strdup ("Träd");
    char *Leksak = strdup("Leksak");
    char *Rod = strdup ("Röd");
    char *Solros = strdup("Solros");
    char *Gul = strdup ("Gul");
    ...
    CU_ASSERT_TRUE(ioopm_hash_table_lookup(warehouse,(elem_t)
    {
        .str_value = "Boll"
    }).success);
    CU_ASSERT_TRUE(ioopm_hash_table_lookup(warehouse,(elem_t)
...
//ADD merchendise to warehouse
    ...
    char *Z51 = strdup("Z51");
    //Replenishar
    warehouse_store_location(warehouse, shelf_db, A25, (elem_t)
    {
        .str_value = "Boll"
    }, 5);
    warehouse_store_location(warehouse, shelf_db, B12, (elem_t)
    {
        .str_value = "Skog"
    }, 1);
    warehouse_store_location(warehouse, shelf_db, Z51, (elem_t)
    {
        .str_value = "Solros"
    }, 1);

    //Kollar att shelf_db innehåller namn till respektive hylla
    char *merch_name = ioopm_hash_table_lookup(shelf_db, (elem_t)
    {
        .str_value = A25
    }).element.str_value;
    CU_ASSERT_STRING_EQUAL("Boll", merch_name);

    merch_name = ioopm_hash_table_lookup(shelf_db, (elem_t)
    {
        .str_value = B12
    }).element.str_value;
    ...
    warehouse_store_location(warehouse, shelf_db, newshelf, (elem_t)
    {
        .str_value = "Boll"
    }, 2);
    warehouse_store_location(warehouse, shelf_db, newshelf2, (elem_t)
    {
        .str_value = "Skog"
    }, 4);
...
//ADD merchendise to warehouse
    ...
    warehouse_edit_merchandise_with_fields(warehouse, shelf_db, tomte, skagg, 200, (elem_t)
    {
        .str_value = "Skog"
    }, list_of_carts);

    warehouse_edit_merchandise_with_fields(warehouse, shelf_db, julgran, plast, 200, (elem_t)
    {
        .str_value = "Leksak"
    }, list_of_carts);
    ...
    CU_ASSERT_FALSE(ioopm_hash_table_lookup(warehouse,(elem_t)
    {
        .str_value = "Skog"
    }).success);
...
void test_remove_merch()
{
    ...
    warehouse_remove_merch_with_key(warehouse, shelf_db, (elem_t)
    {
        .str_value = "Boll"
    }, list_of_carts);
    warehouse_remove_merch_with_key(warehouse, shelf_db, (elem_t)
...
void test_add_to_cart()
{
    ...
    //Replenish
    warehouse_store_location(warehouse, shelf_db, shelf1, (elem_t)
    {
        .str_value = Boll
    }, 5);
    warehouse_store_location(warehouse, shelf_db, shelf2, (elem_t)
    {
        .str_value = Skog
    }, 3);
    warehouse_store_location(warehouse, shelf_db, shelf3, (elem_t)
    {
        .str_value = Solros
    }, 10);
    ...
    add_merchandise_to_cart_with_index(warehouse, list_of_carts, 0, (elem_t)
    {
        .str_value = Boll
    }, 4);
    add_merchandise_to_cart_with_index(warehouse, list_of_carts, 0, (elem_t)
...
//ADD merchendise to warehouse
    ...
    CU_ASSERT_TRUE(warehouse_key_has_locations(warehouse, (elem_t)
    {
        .str_value = "Skog"
    }));
    CU_ASSERT_TRUE(warehouse_key_has_locations(warehouse, (elem_t)
    ...
    CU_ASSERT_FALSE(warehouse_key_has_locations(warehouse, (elem_t)
    {
        .str_value = "Leksak"
    }));
    CU_ASSERT_FALSE(warehouse_key_has_locations(warehouse, (elem_t)
...
//ADD merchendise to warehouse
    ...
    CU_ASSERT_TRUE(is_shelf_available(warehouse, shelf_db, "Y05", (elem_t)
    {
        .str_value = "Boll"
    }));
    CU_ASSERT_TRUE(is_shelf_available(warehouse, shelf_db, "A25", (elem_t)
    {
        .str_value = "Boll"
    }));
    CU_ASSERT_TRUE(is_shelf_available(warehouse, shelf_db, "B12", (elem_t)
    {
        .str_value = "Skog"
    }));
...
//ADD merchendise to warehouse
    ...
    CU_ASSERT_TRUE(amount_to_add_available(warehouse, (elem_t)
    {
        .str_value = "Boll"
    }, 1));
    CU_ASSERT_TRUE(amount_to_add_available(warehouse, (elem_t)
    ...
    CU_ASSERT_FALSE(amount_to_add_available(warehouse, (elem_t)
    {
        .str_value = "Skog"
    }, 3));
    CU_ASSERT_TRUE(amount_to_add_available(warehouse, (elem_t)
...
//ADD merchendise to warehouse
    ...
    CU_ASSERT_TRUE(is_merch_stocked(warehouse, (elem_t)
    {
        .str_value = "Skog"
    }));
    CU_ASSERT_TRUE(is_merch_stocked(warehouse, (elem_t)
    ...
    CU_ASSERT_FALSE(is_merch_stocked(warehouse, (elem_t)
    {
        .str_value = "Leksak"
    }));
    CU_ASSERT_FALSE(is_merch_stocked(warehouse, (elem_t)
...
void test_size_of_cart()
{
    ...
    warehouse_list_locations(warehouse,(elem_t)
    {
        .str_value = "Boll"
    });
...
void test_remove_with_cart()
{
    ...
    add_merchandise_to_cart_with_index(warehouse, list_of_carts, 1, (elem_t)
    {
        .str_value = "Leksak"
    }, 3);
    add_merchandise_to_cart_with_index(warehouse, list_of_carts, 2, (elem_t)
    {
        .str_value = "Leksak"
    }, 4);
    ...
    warehouse_store_location(warehouse, shelf_db, shelf12, (elem_t)
    {
        .str_value = "Boll"
    }, 7);
    add_merchandise_to_cart_with_index(warehouse, list_of_carts, 0, (elem_t)
