...
#define int_elem(e) (elem_t){ .i=(e) }
#define str_elem(e) (elem_t){ .p=(e) }
#define ioopm_int_linked_list_create() \
   ioopm_linked_list_create(ioopm_int_eq)
#define ioopm_int_linked_list_append(list, e)   \
    ioopm_linked_list_append(list, int_elem(e))
#define ioopm_int_linked_list_prepend(list, e)   \
    ioopm_linked_list_prepend(list, int_elem(e))
#define ioopm_int_linked_list_insert(list, index, e)   \
    ioopm_linked_list_insert(list, index, int_elem(e))
#define ioopm_int_linked_list_get(list, index)   \
    ioopm_linked_list_get(list, index).i


bool ioopm_int_eq(elem_t x, elem_t y);
bool ioopm_unsigned_int_eq(elem_t x, elem_t y);
bool ioopm_bool_eq(elem_t x, elem_t y);
bool ioopm_float_eq(elem_t x, elem_t y);

/// @brief Creates a new empty list
/// @param eq the equality function of the list
